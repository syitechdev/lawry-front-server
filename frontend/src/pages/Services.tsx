          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center justify-center space-x-4 mb-8">
                <span
                  className={`text-sm font-medium ${
                    !isYearly ? "text-red-900" : "text-gray-500"
                  }`}
                >
                  Mensuel
                </span>
                ...
                return (
                  <Card
                    ...
                    className={`relative overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl ${
                      plan.popular
                        ? "ring-2 ring-blue-500 bg-gradient-to-br from-blue-50 to-white scale-105"
                        : "bg-white"
                    }`}
                  >
                    {plan.popular && (
                    ...
                    <div className="relative p-8">
                      ...
                      <Button
                        ...
                        } transition-all duration-200 shadow-md hover:shadow-lg hover:scale-105 py-3`}
                      >
            ...
            <div className="text-center mt-12">
              <p className="text-sm text-gray-500 mb-4">
                Toutes nos offres incluent un support client dédié et une
