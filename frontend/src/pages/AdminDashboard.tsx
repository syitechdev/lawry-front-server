...
const AdminDashboard = () => {
  ...
  const activitesRecentes = [
    ...
    {
      action: "Dossier SAS validé",
      utilisateur: "Me Konan",
      temps: "Il y a 3h",
    },
    {
      action: "Paiement reçu",
      utilisateur: "SARL TechCorp",
      temps: "Il y a 5h",
    },
  ...
  const handleExportReport = () => {
    ...
    try {
      ...
      logoImg.onload = function () {
        ...
        doc.addImage(
          "/lovable-uploads/8ddd9075-95fd-4813-befd-8e6012ca6e9b.png",
          "PNG",
          20,
          10,
          30,
        ...
        for (let i = 1; i <= pageCount; i++) {
          ...
          doc.text(
            "Rapport généré par Lawry - Cabinet Juridique Digital",
            20,
            285
          );
      ...
      <div className="ml-80 px-8 py-8">
            ...
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-red-100">
                  Analyse complète de vos performances et gestion IA
                </p>
              </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card className="bg-gradient-to-br from-indigo-500 to-indigo-600 text-white border-0 shadow-xl">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {statistiquesIA.utilisationsTotal.toLocaleString()}
                </div>
                <p className="text-xs text-indigo-100">
                  +{statistiquesIA.utilisationsAujourdhui} aujourd'hui
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-cyan-500 to-cyan-600 text-white border-0 shadow-xl">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {statistiquesIA.tempsReponsesMoyen}
                </div>
            ...
            <Card className="bg-gradient-to-br from-emerald-500 to-emerald-600 text-white border-0 shadow-xl">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {statistiquesIA.tauxSatisfaction}%
                </div>
            ...
            <Card className="bg-gradient-to-br from-amber-500 to-amber-600 text-white border-0 shadow-xl">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {statistiquesIA.economiesRealisees}
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {performanceIA.map((metrique, index) => (
              <Card
                key={index}
                className="bg-gradient-to-br from-gray-50 to-gray-100 border-gray-200 shadow-lg"
              >
                <CardHeader>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {statistiquesIA.questionsResolues}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-green-700">Escalations:</span>
                    <span className="font-medium">
                      {statistiquesIA.escalationsHumaines}
                    </span>
                  </div>
                </div>
              </CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white border-0 shadow-xl">
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {statistiques.demandesTerminees}
              </div>
            ...
            <CardContent>
              <div className="space-y-2">
                <p className="text-sm text-yellow-700">
                  • {statistiques.demandesAttente} dossiers en attente
                </p>
                <p className="text-sm text-yellow-700">
                  • 3 paiements en retard
                </p>
                <p className="text-sm text-yellow-700">
                  • 2 documents à valider
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-red-700 mb-4">
                  Gérez efficacement votre cabinet juridique avec tous les
                  outils nécessaires. Utilisez la barre de navigation à gauche
