...
const ChatBot = () => {
  ...
  const legalKnowledge = [
    {
      ...
      content:
        "Explication des SARL, SAS, SCI, etc. Leurs avantages et inconvénients.",
      keywords: [
        "SARL",
        "SAS",
        "SCI",
    ...
    },
    {
      ...
      content:
        "Les clauses essentielles, la période d'essai, la rupture du contrat.",
      keywords: [
        "CDI",
        "Période d'essai",
        "Rupture",
    ...
    },
    {
      ...
      content:
        "Pourquoi signer un NDA ? Les informations protégées, la durée de l'accord.",
      keywords: [
        "NDA",
        "Confidentialité",
    ...
    },
    {
      ...
      content:
        "Les obligations du bailleur et du locataire, le renouvellement du bail, le loyer.",
      keywords: [
        "Bail commercial",
        "Loyer",
        "Renouvellement",
  ...
  const contractTypes = [
    ...
    },
    {
      ...
      description:
        "Protégez vos informations sensibles avec un accord de confidentialité",
  ...
  const generateBotResponse = (userMessage: string) => {
    ...
    if (
      message.includes("sci") ||
      message.includes("société civile immobilière")
    ) {
    ...
    if (
      message.includes("contrat de travail") ||
      message.includes("cdi") ||
      message.includes("embauche")
    ) {
  ...
  const handleContractGeneration = (contractData: any) => {
    ...
    toast({
      ...
      description:
        "Votre contrat a été généré avec succès. Vous pouvez maintenant le prévisualiser et le modifier.",
    });
  };
      ...
      <section className="pt-20 pb-8 sm:pt-24 sm:pb-12 bg-gradient-to-r from-red-900 to-red-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-6 sm:mb-8 max-w-3xl mx-auto text-red-100 px-2">
            Obtenez des réponses à vos questions juridiques, générez des
            documents et créez votre entreprise en toute simplicité
          </p>
        ...
        <section className="py-8 sm:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <Card
                className="hover:shadow-xl transition-all duration-300 group cursor-pointer border-blue-200 hover:border-blue-400"
                onClick={() => setActiveSection("chat")}
              >
                ...
                <CardContent className="p-4 sm:p-6 pt-0">
                  <ul className="space-y-2 text-xs sm:text-sm text-gray-600">
                    <li className="flex items-center">
                      <ChevronRight className="h-3 w-3 mr-2 text-blue-600 flex-shrink-0" />
              ...
              <Card
                className="hover:shadow-xl transition-all duration-300 group cursor-pointer border-green-200 hover:border-green-400"
                onClick={() => navigate("/creer-entreprise")}
              >
                <CardHeader className="p-4 sm:p-6">
                  <div className="flex items-center justify-between">
                  ...
                  <CardDescription className="text-sm">
                    Générez votre dossier de création d'entreprise en quelques
                    clics
                  </CardDescription>
                </CardHeader>
                <CardContent className="p-4 sm:p-6 pt-0">
              ...
              <Card
                className="hover:shadow-xl transition-all duration-300 group cursor-pointer border-purple-200 hover:border-purple-400"
              ...
              >
                <CardHeader className="p-4 sm:p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge
                      variant="outline"
                      className="border-purple-200 text-purple-800 text-xs"
                    >
                      Nouveau
                    </Badge>
                  </div>
                  <CardTitle className="text-purple-900 text-base sm:text-lg">
                    Formation
                  </CardTitle>
                  <CardDescription className="text-sm">
                    Formations juridiques interactives avec évaluation et
                    certification
                  </CardDescription>
                </CardHeader>
                <CardContent className="p-4 sm:p-6 pt-0">
                  <ul className="space-y-2 text-xs sm:text-sm text-gray-600">
                    <li className="flex items-center">
                      <ChevronRight className="h-3 w-3 mr-2 text-purple-600 flex-shrink-0" />
              ...
              <Card
                className="hover:shadow-xl transition-all duration-300 group cursor-pointer border-red-200 hover:border-red-400"
                onClick={() => navigate("/redaction-contrat")}
              >
                <CardHeader className="p-4 sm:p-6">
                  <div className="flex items-center justify-between">
                ...
                <CardContent className="p-4 sm:p-6 pt-0">
                  <ul className="space-y-2 text-xs sm:text-sm text-gray-600">
                    <li className="flex items-center">
                      <ChevronRight className="h-3 w-3 mr-2 text-red-600 flex-shrink-0" />
                      CDI, NDA, Bail commercial
                    </li>
                    <li className="flex items-center">
                      <ChevronRight className="h-3 w-3 mr-2 text-red-600 flex-shrink-0" />
        ...
        <section className="py-8 sm:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Button
                onClick={sendMessage}
                className="bg-red-900 hover:bg-red-800 text-sm sm:text-base w-full sm:w-auto"
              >
      ...
      {activeSection === "app-download" && (
        <section className="py-8 sm:py-16">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8 space-y-4 sm:space-y-0">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">
                Télécharger l'application LAWRY
              </h2>
              <Button
                variant="outline"
                onClick={() => setActiveSection("")}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="lg:col-span-2">
                <Card>
                  <CardHeader className="p-4 sm:p-6">
                    ...
                    <CardDescription className="text-sm">
                      Accédez à tous vos services juridiques depuis votre
                      smartphone
                    </CardDescription>
                  </CardHeader>
                    ...
                    <div className="bg-gray-50 p-4 sm:p-6 rounded-lg text-center">
                      ...
                      <div className="flex flex-col items-center justify-center gap-4 sm:gap-6">
                        ...
                        <div className="text-xs sm:text-sm text-gray-600 max-w-xs text-center">
                          ...
                          <p>
                            Ouvrez l'appareil photo de votre téléphone et
                            pointez-le vers le code QR pour télécharger
              ...
              <div className="lg:col-span-1">
                <Card className="bg-gradient-to-br from-red-50 to-red-100 border-red-200">
                  <CardHeader className="p-4 sm:p-6">
                    <CardTitle className="text-center text-red-900 text-base sm:text-lg">
                        ...
                        <div className="w-full h-full bg-white rounded-[1.75rem] sm:rounded-[2.5rem] overflow-hidden relative">
                          ...
                          <div className="p-3 sm:p-4 h-full bg-gradient-to-br from-slate-50 to-red-50">
                            <div className="text-center mb-4 sm:mb-6">
                              <h3 className="text-sm sm:text-lg font-bold text-red-900 mb-1 sm:mb-2">
                                Assistant Juridique
                              </h3>
                              <p className="text-xs text-gray-600">
                                Votre expert juridique de poche
                              </p>
                            </div>
                            ...
                            <div className="bg-white p-2 sm:p-3 rounded-lg">
                              ...
                              <div className="text-xs bg-gray-100 p-2 rounded">
                                Bonjour ! Comment puis-je vous aider avec vos
                                questions juridiques aujourd'hui ?
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <CardContent className="p-4 sm:p-6">
                <div className="text-center">
                  ...
                  <p className="text-sm sm:text-base text-yellow-700 mb-4">
                    ...
                    développement. Inscrivez-vous pour être notifié dès sa
                    sortie !
                  </p>
                  ...
                  <CardContent className="p-4 sm:p-6">
                    <div className="space-y-3">
                      <div className="text-sm text-gray-600">
                        Générez votre dossier de création d'entreprise
                        gratuitement
                      </div>
                      <Button
                        onClick={() => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
              ...
              <Card className="border-green-200 hover:shadow-lg transition-shadow">
                <CardHeader className="p-4 sm:p-6">
                  ...
                  <CardDescription className="text-sm">
                    Demandez un devis pour une formation personnalisée pour
                    votre équipe
                  </CardDescription>
                </CardHeader>
            ...
            <Tabs defaultValue="general" className="w-full">
              ...
              <TabsContent value="general">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">
                    Lawry est un assistant juridique virtuel qui vous aide à
                    résoudre vos problèmes juridiques.
                  </p>
                  ...
                  <p className="text-gray-600">
                    Vous pouvez nous contacter par email à contact@lawry.ci ou
                    par téléphone au 07 09 12 20 74.
                  </p>
                </div>
              </TabsContent>
              <TabsContent value="contrats">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">
                    Sélectionnez le type de contrat souhaité, remplissez les
                    informations demandées et générez votre contrat.
                  </p>

                  <div className="text-lg font-semibold">
                    Puis-je modifier un contrat généré ?
                  </div>
                  <p className="text-gray-600">
                    Oui, vous pouvez modifier le contrat généré avant de le
                    télécharger.
                  </p>
                </div>
              </TabsContent>
              <TabsContent value="entreprises">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">
                    Sélectionnez le type d'entreprise que vous souhaitez créer
                    et suivez les instructions.
                  </p>

                  <div className="text-lg font-semibold">
                    Quels sont les types d'entreprises disponibles ?
                  </div>
                  <p className="text-gray-600">
                    Nous proposons la création de SARL, SAS et SCI.
                  </p>
                </div>
              </TabsContent>
            </Tabs>
        ...
        <Dialog open={showContractForm} onOpenChange={setShowContractForm}>
          <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Remplissez les informations nécessaires pour générer votre
