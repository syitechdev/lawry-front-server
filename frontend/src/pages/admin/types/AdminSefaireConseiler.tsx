...
export default function AdminSefaireConseiler() {
  ...
  // ⬅️ Slug pour "Se faire conseiller"
  const typeSlug = "se-faire-conseiller";
  ...
  const load = async () => {
    ...
    try {
      ...
      const normalized: FormCard[] = arr.map((c) => ({
        ...
        cta: c.cta ?? "Choisir cette formule",
  ...
  const saveConfig = async (
    ...
    const config = { variant_cards: effectiveCards, order: effectiveOrder };
  ...
  const toggleActive = async (key: string) => {
    ...
    await saveConfig(true, nextCards, order);
    toast({
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-red-900 to-red-800 text-white rounded-2xl p-8 shadow-xl">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold">Se faire conseiller</h1>
                <p className="text-red-100">
                  Gérez les formules visibles côté client (titre, prix, points,
                  CTA, pastille).
                </p>
              </div>
              <Dialog
                  ...
                  <div className="grid gap-5">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Input
                          placeholder="Conseil juridique immédiat"
                          value={form.subtitle}
                          onChange={(e) =>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label>Pastille (ex: 30 minutes)</Label>
                        <Input
                          placeholder="30 minutes"
                          value={form.pill ?? ""}
                          onChange={(e) =>
                            setForm({ ...form, pill: e.target.value })
                          }
                        />
                      </div>
                      <div>
            ...
            <Card key={c.key} className="hover:shadow-lg transition-shadow">
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  <div>
                    <CardTitle className="text-[22px] leading-6 text-red-900">
                      {c.title}
                    </CardTitle>
                    {c.subtitle && (
                  ...
                  <div className="flex items-center gap-2">
                    {!!c.pill && (
                      <span className="rounded-full bg-rose-50 text-rose-900 text-xs font-semibold px-3 py-1 border border-rose-100">
                        {c.pill}
                      </span>
                    )}
                    <Badge
