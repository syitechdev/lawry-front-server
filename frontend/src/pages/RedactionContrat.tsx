...
import { FileText, CheckCircle, Clock, Users, Shield, Star } from "lucide-react";
...
const RedactionContrat = () => {
  const contractTypes = [{
    ...
    features: ["Clauses personnalisées", "Conforme au droit ivoirien", "Révision incluse"]
  }, {
    title: "Contrat commercial",
    description: "Vente, prestation, partenariat",
    price: "À partir de 100 000 FCFA",
    features: ["Conditions négociées", "Protection juridique", "Clauses spécifiques"]
  }, {
    title: "Contrat immobilier",
    description: "Bail, vente, gestion locative",
    price: "À partir de 125 000 FCFA",
    features: ["Conforme à la loi", "Clauses de protection", "Annexes incluses"]
  }, {
    title: "Contrat sur mesure",
    description: "Contrat spécifique à votre activité",
    price: "Sur devis",
    features: ["Entièrement personnalisé", "Expertise pointue", "Accompagnement dédié"]
  }];
      ...
      <section className="py-16 bg-gradient-to-r from-red-900 to-red-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto text-red-100">
            Protégez vos intérêts avec des contrats sur mesure, rédigés par nos juristes experts
          </p>
          <Button 
            size="lg" 
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {contractTypes.map((contract, index) => <Card key={index} className="hover:shadow-xl transition-all duration-300 group hover:scale-105">
                <CardHeader>
                  ...
                  <div className="text-2xl font-bold text-gray-900">{contract.price}</div>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-3 mb-6">
                    {contract.features.map((feature, idx) => <li key={idx} className="flex items-center text-gray-600">
