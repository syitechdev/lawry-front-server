...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-red-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link
                to="/about"
                className="text-red-900 font-semibold border-b-2 border-red-900 pb-1"
              >
                À propos
              </Link>
              <Link
      ...
      {/* Hero Section */}
      <section className="relative py-20 mt-10 overflow-hidden bg-gradient-to-r from-red-900 to-red-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-6 text-lg text-gray-700">
                <p>
                  <strong className="text-red-900">Laurie Noëlla Chérif</strong>
                  , passionnée du droit au service des PME et animée par une
                  vision claire : rendre le droit accessible et compréhensible
                  pour les entrepreneurs, s'est imposée comme une figure clé du
                  secteur juridique en Côte d'Ivoire. Avec une passion
                  inébranlable pour le droit des affaires, elle a fondé LAWRY
                  Cabinet de Conseil & Assistance Juridique, dédié à
                  l'accompagnement personnalisé des petites et moyennes
                  entreprises ainsi que des particuliers.
                </p>
                <p>
                  Son expérience en cabinet d'avocats lui a permis de constater
                  les défis majeurs auxquels les entrepreneurs sont confrontés
                  en l'absence d'un accompagnement juridique adapté. Déterminée
                  à changer les choses, Laurie a créé des solutions sur mesure
                  pour soutenir la croissance et assurer la pérennité des
                  entreprises locales.
                </p>
      ...
      <section
        id="stats-section"
        className="py-16 bg-gradient-to-br from-gray-50 to-red-50"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              L'excellence mesurée par nos résultats
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <Card
                key={index}
                className="p-8 text-center bg-white shadow-lg hover:shadow-xl transition-shadow border-0"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                ...
                services de qualité, accessibles et innovants pour tous. Nous
                croyons que chaque entreprise et chaque particulier mérite un
                accompagnement juridique professionnel, sans contraintes
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-red-200 text-sm">
                      Expertise reconnue et mise à jour constante
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-red-200 text-sm">
                      Technologie au service de l'efficacité
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              Devenir un acteur incontournable du conseil et de l'assistance
              juridique sur mesure, en Afrique et à l'international, grâce à une
              approche moderne, accessible et axée sur les besoins de nos
              clients.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <Card className="p-6 bg-white border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Extension africaine avec des partenariats stratégiques
              </p>
            </Card>
            <Card className="p-6 bg-white border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Objectif de 10 000 clients actifs d'ici 3 ans
              </p>
            </Card>
            <Card className="p-6 bg-white border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Développement d'IA juridique avancée
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="p-6 bg-gradient-to-br from-red-50 to-white border-red-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Pour répondre aux défis juridiques des technologies et des
                données.
              </p>
            </Card>
            <Card className="p-6 bg-gradient-to-br from-red-50 to-white border-red-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Pour offrir des solutions humaines et adaptées aux questions
                familiales.
              </p>
            </Card>
            <Card className="p-6 bg-gradient-to-br from-red-50 to-white border-red-100 hover:shadow-lg transition-shadow">
      ...
      <section className="py-16 bg-gradient-to-r from-red-900 to-red-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            Rejoignez les milliers de clients qui ont choisi LAWRY pour leurs
            besoins juridiques
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-white text-red-900 hover:bg-red-50 text-lg px-8 py-3"
              asChild
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li>
                  <Link to="/services/rh" className="hover:text-red-900">
                    Gestion RH
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                ...
                <li>
                  <Link to="/formations" className="hover:text-red-900">
                    Formations
                  </Link>
                </li>
                <li>
                  <Link to="/faq" className="hover:text-red-900">
                    FAQ
                  </Link>
                </li>
                <li>
